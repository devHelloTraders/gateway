        ...
        http
            ...
            .authorizeExchange(authz ->
                ...
                authz
                    ...
                    .pathMatchers("/api/admin/**").hasAuthority(AuthoritiesConstants.BROKER)
                    .pathMatchers("/api/admin/scrip/**").hasAuthority(AuthoritiesConstants.ADMIN)
                    .pathMatchers("/api/admin/default-conf/**").hasAuthority(AuthoritiesConstants.BROKER)
                    .pathMatchers("/api/admin/register").hasAuthority(AuthoritiesConstants.BROKER)
                    .pathMatchers("/api/admin/dashboard/**").hasAuthority(AuthoritiesConstants.BROKER)
                    .pathMatchers("/api/admin/action-log/**").hasAuthority(AuthoritiesConstants.BROKER)
                    .pathMatchers("/api/admin/activepositions/**").hasAuthority(AuthoritiesConstants.BROKER)
                    .pathMatchers("/api/admin/closedpositions").hasAuthority(AuthoritiesConstants.BROKER)
                    .pathMatchers("/api/admin/trading-clients/**").hasAuthority(AuthoritiesConstants.BROKER)
